...
export const getRandomQuizzes = (numberOfQuiz) => {

console.log(numberOfQuiz)
if(numberOfQuiz<1){
    throw "Geçersiz quiz sayısı: "+numberOfQuiz;
}
if(numberOfQuiz>quizzes.length){
    throw "Çok sayıda quiz";
}

const selection = Array(numberOfQuiz);
let i=0;
while(i<numberOfQuiz){
